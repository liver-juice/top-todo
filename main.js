...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _project_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project.js */ \"./src/project.js\");\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n\n\n\n// import Project\n\nlet TodoList = (function(){\n    // lists all project objects.\n    let projectList = [];\n    let currentProject;\n    \n    //if no projects give a project. checkProjects.\n    let checkProjects = () => {\n        if (projectList.length === 0){\n            let newProj = (0,_project_js__WEBPACK_IMPORTED_MODULE_1__.Project)('default');\n            projectList.push(newProj);\n            currentProject = projectList[0];\n        }\n    }\n\n    checkProjects();\n\n    currentProject = projectList[0];\n\n    // app active var for event loop\n    let isActive = true;\n\n    // create a project\n    let createProject = () => { \n        let name = prompt('enter new project name: ');\n\n        let createdProject = (0,_project_js__WEBPACK_IMPORTED_MODULE_1__.Project)(name);\n        projectList.push(createdProject);\n    }\n\n    // delete a project\n    let removeProject = () => {\n        let name = prompt('enter project name to remove: ');\n\n        projectList = projectList.filter((project) => project.getName() !== name);\n        checkProjects();\n    }\n\n    // switch the currentProject\n    let switchCurrentProject = () => {\n        let name = prompt('enter project name to change to: ');\n\n        projectList.forEach((project) => {\n            if (project.getName() === name){\n                currentProject = project;\n            }\n        })\n    }\n\n    let displayProjectList = () => {\n        projectList.map((project) => {\n            console.log(project.getName());\n        });\n    }\n\n\n\n    // return the app state\n    let getState = () => {\n        return isActive;\n    }\n\n    let setStateQuit = () => {\n        isActive = false;\n    }\n\n    let getProjectList = () => {\n        return projectList;\n    }\n\n    let getCurrentProject = () => {\n        return currentProject;\n    }\n\n    \n\n    return {createProject, removeProject, switchCurrentProject, getState, setStateQuit, getProjectList, getCurrentProject, displayProjectList};    \n\n})();\n\n\n// EVENT LOOP\nlet currentState = TodoList.getState();\nwhile (currentState === true){\n    let currentProject = TodoList.getCurrentProject();\n    let projectname = currentProject.getName();\n    TodoList.displayProjectList();\n    let userAction = prompt(`CURRENT PROJECT: ${projectname} | create, remove, switch projects? showtodos, newtodo, or deltodo? (quit to quit): `);\n    if (userAction == 'create'){\n        TodoList.createProject();\n    }\n    if (userAction == 'remove'){\n        TodoList.removeProject();\n    }\n    if (userAction == 'switch'){\n        TodoList.switchCurrentProject();\n    }\n    if (userAction == 'showtodos'){\n        let currentProj = TodoList.getCurrentProject();\n        currentProj.displayTodos();\n    }\n    if (userAction == 'newtodo'){\n        let currentProj = TodoList.getCurrentProject();\n        currentProj.createTodo();\n    }\n    if (userAction == 'deltodo'){\n        let currentProj = TodoList.getCurrentProject();\n        currentProj.removeTodo();\n    }\n\n\n\n    if (userAction == 'quit'){\n        TodoList.setStateQuit();\n    }\n    \n    \n    currentState = TodoList.getState();\n}\n\n\n//# sourceURL=webpack://top-todo/./src/index.js?");
